...
void frie_1(){
 ...
 if((millis()-TIME_2)>500){
  ...
  if(sensorValue<=800){digitalWrite(22,HIGH);analogWrite(4,20);delay(1000);}
...
void frie_2(){
 ...
 if((millis()-TIME_3)>500){
  ...
  Serial.print(sensorValue+String(","));
  if(sensorValue<=800){digitalWrite(24,HIGH);analogWrite(7,20);delay(1000);}
...
void frie_4(){
 ...
 if((millis()-TIME_7)>500){
  ...
  if(sensorValue<=800){digitalWrite(27,HIGH);analogWrite(12,20);delay(1000);}
...
void SERVO(){
  static unsigned long TIME_9 = millis();
  if((millis()-TIME_9)>1000){
